        ...
        <nav className='flex items-center justify-between h-[104px] px-[160px]'>
            ...
            <div className='flex gap-3'>
                <div className='bg-product-purple-light text-product-purple-dark flex items-center gap-1 p-2 rounded '>
                    ...
                    <span className='font-roboto text-sm cursor-pointer' onClick={clearCoffeeListCart}>Mombaça, CE (clear)</span>
                </div>
                <Link to='/checkout'>
                    
                    <Button layout='headerCart' icon={ShoppingCart} title={String(cart.length)}  />
                </Link>
            </div>
        </nav>
    )
